...
let api_key = "ebf4f2f58179610cdf576a91";

const dropList = document.querySelectorAll("form select");
const fromCurrency = document.querySelector(".from select");
const toCurrency = document.querySelector(".to select");
const getBtn = document.querySelector(".exchange-rate button");
const amount = document.querySelector(".from input");
const exchangeRateText = document.querySelector(".exchange-rate button");
...
const getExchangeRate = () => {
  ...
  exchangeRateText.innerText = "Loading...";
  ...
  fetch(url)
    ...
    .then((result) => {
      if (result.result === "success") {
        ...
        exchangeRateText.innerText = `API Error`;
      }
    })
    .catch(() => {
